    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: Ext.define('WallpaperModel', {
                ...
                root: {
                    ...
                    children:[
                        ...
                        child('../web/desktop/wallpapers/Blue-Sencha.jpg'),
                        child('../web/desktop/wallpapers/Dark-Sencha.jpg'),
                        child('../web/desktop/wallpapers/Wood-Sencha.jpg'),
                        child('../web/desktop/wallpapers/blue.jpg'),
                        child('../web/desktop/wallpapers/desk.jpg'),
                        child('../web/desktop/wallpapers/desktop.jpg'),
                        child('../web/desktop/wallpapers/desktop2.jpg'),
                        child('../web/desktop/wallpapers/sky.jpg')
                    ]
                }
            })
        });
